...
import { s as S, d as y, e as R } from "./scrollToSection.w7XsRc4Z.js";
import { aw as $ } from "./siteModulesConstants.oOf1HLbO.js";
const E = /\s|&nbsp;/g,
  M = (t) => {
    try {
...
function I(t, e, o, s, i, c) {
  return b(), _("a", { href: t.to.path }, [w(t.$slots, "default")], 8, B);
}
const L = v(x, [["render", I]]),
  T = () => {
...
function j(t) {
  ...
  if (typeof t == "object") {
    ...
    i
      ...
      c && S({ linkToSection: c, isInstant: o });
    ...
    if (r) (r.props = o), (r.slots = a), r.component.$forceUpdate();
      ...
      const n = h({
        ...
        render() {
          ...
          return (r.component = this), q(e.setup) && (u = l(A, null, u)), u;
        },
      });
